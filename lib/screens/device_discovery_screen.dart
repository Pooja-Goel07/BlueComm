        ...
        return AlertDialog(
          ...
          content: const SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text('1. Make sure Bluetooth is enabled and permissions are granted.'),
                SizedBox(height: 8),
                Text('2. Both devices must be running the BlueComm app.'),
                SizedBox(height: 8),
                Text('3. Connect to the device you want to communicate with via Bluetooth settings.'),
                SizedBox(height: 8),
